...
public:
    ErrorEventI2CInitFailed() :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Initialization, CodeID::I2CInitFailed, Error::ErrorLevel::Trace)
    {
    }
};
...
public:
    ErrorEventCreateFailed(esp_err_t err) :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Initialization, CodeID::CreateFailed, Error::ErrorLevel::Trace)
    {
        appendPayload(err);
    }
};
...
public:
    ErrorEventResetFailed(esp_err_t err) :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Initialization, CodeID::ResetFailed, Error::ErrorLevel::Trace)
    {
        appendPayload(err);
    }
};
...
public:
    ErrorEventConfigFailed(esp_err_t err) :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Initialization, CodeID::ConfigFailed, Error::ErrorLevel::Trace)
    {
        appendPayload(err);
    }
};
...
public:
    ErrorEventWakeUpFailed(esp_err_t err) :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Initialization, CodeID::WakeUpFailed, Error::ErrorLevel::Trace)
    {
        appendPayload(err);
    }
};
...
public:
    ErrorEventSendDataFailed(esp_err_t err) :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Runtime, CodeID::SendDataFailed, Error::ErrorLevel::Trace)
    {
        appendPayload(err);
    }
};
...
public:
    ErrorEventDeleteFailed(esp_err_t err) :
        ErrorEventBuilder(Error::ModuleID::MotorDriver, SubmoduleID::Cleanup, CodeID::DeleteFailed, Error::ErrorLevel::Trace)
    {
        appendPayload(err);
    }
};