...
namespace I2C
{
    ...
    Status Init()
    {
        ...
        i2c_master_bus_config_t primary_config = {
            .i2c_port = I2C_NUM_0,
            .sda_io_num = static_cast<gpio_num_t>(Settings::GetConfig().i2c.primary.gpio_sda),
            .scl_io_num = static_cast<gpio_num_t>(Settings::GetConfig().i2c.primary.gpio_scl),
        ...
        i2c_master_bus_config_t secondary_config = {
            .i2c_port = I2C_NUM_1,
            .sda_io_num = static_cast<gpio_num_t>(Settings::GetConfig().i2c.secondary.gpio_sda),
            .scl_io_num = static_cast<gpio_num_t>(Settings::GetConfig().i2c.secondary.gpio_scl),
            .clk_source = I2C_CLK_SRC_DEFAULT,
            .glitch_ignore_cnt = 7,
            .intr_priority = 0,
            .trans_queue_depth = 0, // no async transactions
